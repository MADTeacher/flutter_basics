...
// Класс игрового поля
class Board {
  static const int heightBoard = 20; // высота игрового поля
  static const int widthBoard = 10; // ширина игрового поля
  static const int posFree = 0; // пустая клетка
  static const int posFilled = 1; // заполненная клетка
  static const int posBoarder = 2; // граница игрового поля

  late List<List<int>> mainBoard; // основное игровое поле
  late List<List<int>> mainCpy; // копия игрового поля
  ...
  void keyboardEventHandler(String key) {
    var x = currentBlock.x;
    var y = currentBlock.y;

    switch (key) {
      case 'rotate': //поворот фигуры
        rotateBlock();
      case 'left': // влево
